    ...
    <section className="travel--section" id="travel">
      ...
      <div className="portfolio--section--container">
        {data?.travel?.map((item, index) => (
          <div key={index} className="travel--section--card">
            <div className="travel--section--card--review">
            ...
            <div className="travel--section--card--author--detail">
              <img src={item.src} alt="Avatar" />
              <div>
                <p className="text-md travel--author--name">
                  {item.author_name}
                </p>
                <p className="text-md travel--author--designation">
